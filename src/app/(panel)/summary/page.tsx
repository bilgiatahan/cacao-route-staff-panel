...
export default async function SummaryPage({ searchParams }: SummaryPageProps) {
  ...
  if (user.role === "admin") {
    ...
    const pendingCount =
      summary.pendingLeave.length + summary.pendingSwaps.length;
        ...
        <section className={PAGE}>
          ...
          <div className="contents lg:flex lg:items-start lg:gap-3.5">
            <SectionBlock
              ...
              meta={
                summary.today ? dayLabel(summary.today, dict) : dict.common.dash
              }
            >
              <OnShiftList
  ...
  const shiftDays =
    summary.myRow?.cells.filter((cell) => cell.shift).length ?? 0;
        ...
        <div className="contents lg:flex lg:items-stretch lg:gap-2">
          {nextShift && (
            <Card
              href={
                nextShift
                  ? panelHref(ROUTES.timetable, { week: weekStart })
                  : undefined
              }
              padding="md"
        ...
        <div className="contents lg:flex lg:items-start lg:gap-3.5">
          <Card className="overflow-hidden lg:min-w-0 lg:flex-1">
            ...
            >
              ...
              <span className="flex-1 truncate text-md font-bold">
                {dict.summary.myWeek}
              </span>
